...
/**
 * Perform SubBytes operation for AES-128 encryption
 *
 * @param input the input string, in hexadecimal number system
 * @returns the output after byte substitution, as a string in hexadecimal number system
 */
string s_box_substitution(string input) 
{
    string s_box[16][16] = {"63", "7C", "77", "7B", "F2", "6B", "6F", "C5",
